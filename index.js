...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:ZanxX\n' 
            + 'ORG: Pengembang Rinn;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=62881023962263:+62 881-0239-62263\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 100
...
/******** OWNER NUMBER**********/
const ownerNumber = ["62881023962263@s.whatsapp.net","62881023962263@s.whatsapp.net"] 
/************************************/
...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Hallo @${num.split('@')[0]}\Selamat datang beban keluarga di group *${mdata.subject}* yang betah ya di sini`
